...
USE [master]
GO
/****** Object:  Database [Gha2zERPDB]    Script Date: 3/26/2024 2:31:51 PM ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'Gha2zERPDB')
DROP DATABASE [Gha2zERPDB]
GO
/****** Object:  Database [Gha2zERPDB]    Script Date: 3/26/2024 2:31:51 PM ******/
...
( NAME = N'Gha2zERPDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.BARTENDER\MSSQL\DATA\Gha2zERPDB.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Gha2zERPDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.BARTENDER\MSSQL\DATA\Gha2zERPDB_log.ldf' , SIZE = 3136KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
